...
const Profile = () => {
  ...
  const userData = {
    ...
    events: [
      { name: "Event One", date: "2024-06-15" },
    ],
    finances: {
      balance: "10000",
    ...
    <div className={styles.profileContainer}>
        ...
        <div className={styles.profileCompleteArea}>
          <div className={styles.uiWidgets}>
              <div className={styles.uiValues}>
                85%
                <h6 className={styles.h6}>profile complete</h6>
              </div>
      ...
      <div className={`${styles.row} ${styles.middle}`}>
        ...
        <div className={styles.profileCard}>
          ...
          <div className={styles.lightBlueRegion}>
            <h4 className={styles.h4}>CBO Memberships</h4>
        ...
        <div className={styles.profileCard}>
          ...
          <div className={styles.financialSection}>
            ...
            <div className={styles.lightRedRegion}> 
              <h4 className={styles.h4}>{userData.finances.contributions} KES</h4>
            </div>
          ...
          {userData.events.map((event, index) => (
            <div key={index} className={styles.eventItem}>
              <div className={styles.dateArea}>
                ...
                <div className={styles.smallMonth}>
                  Nov
                </div>
              </div>
              <div className={styles.detailsArea}>
                <h4 className={styles.h4}>SOME TITLE</h4>
                <div className={styles.eventDetails}>CBO One contribution Deadline</div>
                <div className={styles.eventTime}>
                  <p><MdLockClock /> 10.45 am</p>
                </div>
              </div>
            </div>
          ))}
